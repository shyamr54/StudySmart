...
// Initialize OpenAI client only if we're using OpenAI and have an API key
const openaiApiKey = process.env.OPENAI_API_KEY;
let openai: OpenAI | null = null;

if (AI_PROVIDER === 'openai') {
  if (!openaiApiKey) {
    console.warn('OPENAI_API_KEY is not defined in environment variables. Falling back to OpenRouter.');
  } else {
